                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation": {
                            ...
                            const filename = (tool.args?.path as string | undefined)?.split("/").pop() ?? "";
                            ...
                            if (tool.toolName === "str_replace_editor") {
                              ...
                              const [prog, done] = map[cmd ?? ""] ?? ["Editing", "Edited"];
                              label = `${isDone ? done : prog}${filename ? ` ${filename}` : " files"}`;
                              ...
                              const [prog, done] = map[cmd ?? ""] ?? ["Managing", "Managed"];
                              label = `${isDone ? done : prog}${filename ? ` ${filename}` : " files"}`;
                            }
